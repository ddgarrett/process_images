...
def make_window(theme):
    ...
    # Table Data
    data = [["John", 10], ["Jen", 5],["Able",10],["Baker",15],["Charlie",20],["A Very Very Very Very Long Name",1000000]]
    headings = ["Name", "Score"]
    ...
    graphing_layout = [[sg.Text("Anything you would use to graph will display here!")],
                      ...
                      [sg.Table(values=data, headings=headings, max_col_width=10, # from max_col_width=25
